...
const RecentBlogs = () => {
    return (
        <div className="w-full px-4 pt-16">
            <h1 className='text-2xl text-primary text-center mt-4'>WelComme To Your Blog</h1>
...
There are four main types of state you need to properly manage in your React apps:Local state,Global state,Server state,UR state
              </Disclosure.Panel>
            </>
          )}
        </Disclosure>
